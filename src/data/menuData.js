    ...
    items: [
      {
        ...
        sizes: {
          pequena: { price: 39.9, description: "4 pedaços" },
          grande: { price: 39.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "MARGUERITA",
        description:
          "Molho de tomate, mussarela parmesão, tomate cereja e manjericão",
        sizes: {
          pequena: { price: 52.9, description: "4 pedaços" },
          grande: { price: 73.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        sizes: {
          pequena: { price: 48.9, description: "4 pedaços" },
          grande: { price: 67.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "PRESUNTO",
        description:
          "Molho de tomate, mussarela, presunto, cebola, pimentão e orégano.",
        sizes: {
      ...
      },
      {
        ...
        name: "NAPOLITANA",
        description:
          "  Molho de tomate, mussarela, aliche, tomate cereja e orégano.",
        sizes: {
          pequena: { price: 62.9, description: "4 pedaços" },
          grande: { price: 83.9, description: "8 pedaços" },
        },
        image: "/img/napoletana-pizza.png",
        category: "pizza",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        name: "PORTUGUESA",
        description:
          "Molho de tomate, mussarela, ovos cozidos, presunto, cebola, pimentão e azeitonas.",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "CALABRESA",
        description:
          "Molho de tomate, mussarela, linguiça calabresa, cebola e azeitonas",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "PARMEGIANA",
        description:
          "Molho de tomate, mussarela,, berinjela, parmesão e manjericão.",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "CHAMPIGNON",
        description:
          "Molho de tomate, mussarela, champignons Paris fatia, orégano.",
        sizes: {
          pequena: { price: 53.9, description: "4 pedaços" },
          grande: { price: 74.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        description:
          "Molho de tomate, mussarela, parmesão, champignon, abobrinha, tomate cereja e orégano",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        description:
          "Pomodoro pelate, mussarela, burrata, granapadano e manjericão",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
      ...
      },
      {
        ...
        name: "CAPRICIOSA",
        description:
          "Pomodoro pelate, presunto cozido, coração alcachofra, champignon e bacon",
        sizes: {
          pequena: { price: 56.9, description: "4 pedaços" },
          grande: { price: 77.9, description: "8 pedaços" },
        },
    ...
    items: [
      {
        ...
        description:
          "Molho de tomate, muçarela, parmesão, queijocaprino e abobrinha",
        sizes: {
          pequena: { price: 62.9, description: "4 pedaços" },
          grande: { price: 83.9, description: "8 pedaços" },
        },
  ...
  bebidas: {
    ...
    items: [
      ...
      },
      {
        ...
        price: 12.99,
        image: "/img/Coca-Cola Zero-2L.png",
        category: "bebida",
      },
      {
        id: 27,
      ...
      },
      {
        ...
        price: 5.99,
        image: "/img/Suco-Del-Valle-UVA.png",
        category: "bebida",
      },
      {
        id: 34,
